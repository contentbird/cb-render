    ...
    module Rails
      class Engine < ::Rails::Engine
        initializer "cb-render.assets.precompile" do |app|
          ...
          config.assets.precompile += ["../vendor/assets/fonts/contentbird.svg", "../vendor/assets/fonts/contentbird.eot", "../vendor/assets/fonts/contentbird.woff", "../vendor/assets/fonts/contentbird.ttf"]
